...
import { BookOpen, Search, Mic, Sparkles } from "lucide-react";
          ...
          <form onSubmit={handleSearch} className="flex flex-col sm:flex-row gap-2 max-w-3xl">
            <div className="relative flex-1">
              ...
              <Button
                ...
                className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 p-0 text-muted-foreground hover:text-primary"
                title="Voice search"
              >
